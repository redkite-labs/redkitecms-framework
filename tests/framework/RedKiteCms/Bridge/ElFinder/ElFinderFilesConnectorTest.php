...
/**
 * Class ElFinderFilesConnectorTest
 *
 * @author RedKite Labs <webmaster@redkite-labs.com>
 */
class ElFinderFilesConnectorTest extends TestCase
{
    public function testOptions()
    {
        ...
        $connector = new ElFinderFilesConnector($configurationHandler, $optionsResolver);
